        ...
        <div className="founder-grid">
          ...
          <div className="founder-side">
            ...
            <p className="founder-bio">
              ...
              consumer products that make everyday Indian life a little easier.
              After years of shipping engineering work for other people's
              companies, he started Soartech to chase the small, daily
              frustrations he kept noticing — and to build the quiet, sharp
              tools that fix them.
            </p>
            <p className="founder-bio">
              Soartech is currently a one-person studio. That's intentional, for
              now.
            </p>
            ...
            <div className="founder-trio">
              <div className="cell">
                ...
                <div className="v">
                  Pithoragarh, <em>Uttarakhand</em>
                </div>
              </div>
              <div className="cell">
                <div className="k">Working on</div>
                <div className="v">
                  ShopSwiftly + <em>more soon</em>
                </div>
              </div>
              <div className="cell">
                <div className="k">Open to</div>
                <div className="v">
                  Collaborations, <em>partnerships</em>
                </div>
              </div>
            </div>
          </div>
